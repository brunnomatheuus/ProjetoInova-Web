...
class MetasTrimestrais extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        axios.get(getBaseUrl('local') + '/objetivosOKR?filter={ "where":{"tipo": "Trimestral"} }')
        .then( response => {
            this.setState({metasTrimestrais: response.data})
        })
    }
    ...
    render() {
        let optionObjetivos = this.state.metasTrimestrais.map((objetivo, i) =>
        ...
        return (
            <div className="content">
                ...
                <FormGroup controlId="formControlsSelect2">
                    <ControlLabel>Selecione o trimestre</ControlLabel>
                ...
                <Card
                    title={this.state.trimestre + "º Trimestre de " + this.state.ano}
                    content={
                        <div>
                            <Row>
                                {this.state.metasTrimestrais.map((prop, key) => {
                                    if(prop.ano === this.state.ano && prop.periodo === this.state.trimestre){
...
export default MetasTrimestrais;
